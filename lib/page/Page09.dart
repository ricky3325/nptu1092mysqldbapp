...
class commodAddPage extends StatefulWidget {
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<commodAddPage> {
  ...
  _launchURLupdCont() async {
    ...
    final String url = "http://192.168.1.117/ai2/upd/commodity.php?qno=$U1&nno=$U2&jno=$U3&quantity=$U4";
  ...
  _launchURLaddCont() async {
    ...
    final String U7 = dateDay.text;
    final String U8 = statusInfo.text;
    final String url = "http://192.168.1.117/ai2/add/commodity.php?qno=$U1&nno=$U2&jno=$U3&quantity=$U4";
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
  ...
  _launchURLdelCont() async {
    ...
    final String U7 = dateDay.text;
    final String U8 = statusInfo.text;
    final String url = "http://192.168.1.117/ai2/del/commodity.php?qno=$U1";
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
